...
/**
 * @author guanchen
 * @version $Id AESUtil.java, v 0.1 2018-09-14 17:15 star Exp $$
 */
@Slf4j
public class AESUtil {
     ...
     * 6.返回字符串
     **/
    public static String invokeEncryptEncode(String content, String key) {
        String resultEncode = "";
        try {
            ...
            resultEncode = new StringBuilder(new BASE64Encoder().encode(bytesAes)).toString();
            //[11].将字符串返回
            return resultEncode;
     ...
     * 3.将加密内容解密
     */
    public static String invokeDecryptEncode(String content, String key) {
        String resultEncode = "";
        try {
            KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
            SecureRandom random = SecureRandom.getInstance("SHA1PRNG");
    ...
    public static void main(String[] args) {
        String key = "xinjinbaika";
        String s = "15122201963";

        long  start = System.currentTimeMillis();
        log.info("原始密文key:[" + s + "],");
        String encryptString = invokeEncryptEncode(s,key);
        log.info("加密encryptString:[" + encryptString + "],");
        String decryptString = invokeDecryptEncode(encryptString,key);
        log.info("解密decryptString:[" + decryptString + "]");
